...
// в которой подключить файл 2.js (его тоже необходимо создать рядом с html-файлом). В js-файле необходимо создать следующий скрипт:
...
function greeting(name) {
    console.log(`Hi, ${name}`);
    alert(`Hi, ${name}`);       // alert не нужен, но более логичен для пользователя
}
